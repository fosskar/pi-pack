...
| [security-audit](skills/security-audit/) | Audit a codebase for vulnerabilities and report confirmed findings with evidence and fixes. Original skill by [cloudflare/security-audit-skill](https://github.com/cloudflare/security-audit-skill). Requires `node`.                                           |
| [show-me](skills/show-me/)               | Explain the current topic visually with diagrams, code-shape sketches, and focused HTML artifacts. Original skill by [humanlayer/skills](https://github.com/humanlayer/skills/blob/main/plugins/show-me/skills/show-me/SKILL.md).                               |
| [simplify](skills/simplify/)             | Refine recently modified code for clarity and consistency without changing behavior. Original agent by [anthropics/claude-plugins-official](https://github.com/anthropics/claude-plugins-official/blob/main/plugins/code-simplifier/agents/code-simplifier.md). |
