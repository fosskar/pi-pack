---
name: simplify
description: Review recently changed code for reuse, quality, and efficiency issues, then fix them. Run after implementing a feature or bug fix to clean up your work. Pass optional text to focus on specific concerns.
---
...
Aggregate findings from all three reviews and fix each issue directly. If a finding is a false positive or not worth addressing, note it and move on — do not argue with the finding, just skip it.
